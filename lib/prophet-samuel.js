...
var rxSubscriber_1 = __webpack_require__(/*! ./symbol/rxSubscriber */ 5);
/**
...
var errorObject_1 = __webpack_require__(/*! ./util/errorObject */ 4);
...
var errorObject_1 = __webpack_require__(/*! ./errorObject */ 4);
var tryCatchTarget;
function tryCatcher() {
    try {
...
var _samuel = __webpack_require__(/*! ./core/samuel */ 14);
    ...
    value: function _startListen(paths, options) {
      ...
      this._watcher.on('change', function (eventName, fileName) {
        _this._subject.next({
          event: eventName,
          name: fileName,
          parse: (0, _util.parseRelPath)(paths, fileName)
        });
      });
